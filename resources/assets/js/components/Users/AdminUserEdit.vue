...
<div class="panel panel-inverse" data-sortable-id="ui-widget-1">
    ...
    <div class="panel-body">
            ...
            <div class="row form-group m-b-10">
                ...
                <div class="col-md-9">
                   <v-select label="name"  v-model="user.company" :filterable="false" :options="options" @search="onSearch">
      ...
      <div class="selected d-center">
       ...
       {{ option.id }} <{{ option.company_name }}>
            ...
            <div class="row form-group m-b-10">
                ...
                <div class="col-md-9">
                    <input type="email"  name="user.profile.additional_email" v-model="user.profile.additional_email" class="form-control" placeholder="Enter additional email" />
                    <div class="valid-feedback">Looks good!</div>
                    <div class="valid-tooltip">Looks good!</div>
                </div>
            </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            submitForm(){
                axios.post('/admin/users/update-user', {user:this.user, group:this.usergroup})
                .then(response => {
                    Swal.fire(
      'Выполнено!',
