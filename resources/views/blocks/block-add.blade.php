...
@section('content')
      ...
      <div class="col-lg-12">
        <div class="panel panel-inverse">
            ...
            <div class="panel-heading">
                <h3 class="panel-title">Добавить блок</h3>
            </div>
            <!-- /.panel-header -->
  ...
  <form class="form-horizontal" role="form"  id ="/postblockadd"  method="POST" action="{{ url('/postblockadd') }}">
...
<strong>{{ $errors->first('fare_families_id') }}</strong>
 ...
 <div class="form-group{{ $errors->has('period_begin_at') ? ' has-error' : '' }}">
  ...
  <div class="col-md-6">
  <input id="period_begin_at" type="text" class="form-control" name="period_begin_at" value ="2019-03-30" value="{{ old('period_begin_at') }}">
...
<div class="col-md-6">
<input id="period_end_at" type="text" class="form-control" name="period_end_at" value ="2019-03-31" value="{{ old('period_end_at') }}">
...
<input type="checkbox" name="monday" value="1" readonly >Понедельник
<br>
   <input type="checkbox" name="tuesday" value="1" readonly >Вторник<br>
   <input type="checkbox" name="wednesday" value="1" readonly >Среда<br> 
   <input type="checkbox" name="thursday" value="1"readonly >Четверг<br> 
   <input type="checkbox" name="friday" value="1" readonly >Пятница<br>
    <input type="checkbox" name="saturday" value="1"readonly >Суббота<br> 
   <input type="checkbox" name="sunday" value="1" readonly >Воскресенье<br>
  ...
  <div class="col-md-6">
   <input id="count_places" type="text" class="form-control" name="count_places" value="{{ old('count_places') }}">
  ...
  <div class="col-md-6">
   <input id="ow" type="text" class="form-control" name="ow" value="{{ old('ow') }}">
   @if ($errors->has('ow'))
  <span class="help-block">
  ...
  <div class="col-md-6">
   <input id="infant_ow" type="text" class="form-control" name="infant_ow" value="{{ old('infant_ow') }}">
  ...
  <div class="col-md-6">
   <input id="rt" type="text" class="form-control" name="rt" value="{{ old('rt') }}">
   @if ($errors->has('rt'))
  <span class="help-block">
  ...
  <div class="col-md-6">
   <input id="infant_rt" type="text" class="form-control" name="infant_rt" value="{{ old('infant_rt') }}">
