      ...
      <div class="col-lg-12">
        <div class="panel panel-inverse">
            ...
            <div class="panel-heading">
                <h3 class="panel-title">Редактировать блок</h3>
            </div>
            <!-- /.panel-header -->
            <div class="panel-body">

    <div class="container spark-screen">
  <form class="form-horizontal" role="form"  id ="/postblockedit"  method="POST" action="{{ url('/postblockedit') }}">
...
<div class="col-md-6">
<input id="period_end_at" type="text" class="form-control" name="period_end_at" value ="2019-03-31" value="{{ $place->period_end_at }}">
