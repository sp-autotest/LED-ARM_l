...
@section('content')
  ...
  <form class="form-horizontal" role="form"  id ="/postscheduleadd"  method="POST" action="{{ url('/postscheduleadd') }}">
 ...
 <div class="form-group">
  ...
  <div class="col-md-6">
   <input id="flights" type="text" class="form-control" name="flights" value="{{ old('flights') }}">
...
<span class="help-block">
 ...
 @endif
  ...
  <span class="help-block">
   ...
   <label for="time_departure_at" class="col-md-4 control-label"> Время прибытия</label>
  <div class="col-md-6">
   <input id="time_departure_at" type="text" class="form-control" name="time_departure_at"  value="{{ old('time_departure_at') }}">
  ...
  <div class="col-md-6">
   <input id="time_arrival_at" type="text" class="form-control" name="time_arrival_at" value="{{ old('time_arrival_at') }}">
