...
@section('content')
      ...
      <div class="col-lg-12">
        <div class="panel panel-inverse">
            ...
            <div class="panel-heading">
                <h3 class="panel-title">Редактировать сбор</h3>
            </div>
            <!-- /.panel-header -->
    ...
    <form class="form-horizontal" role="form"  id ="/postfeesplaceedit"  method="POST" action="{{ url('/postfeesplaceedit') }}">
      <input id="feeplace_id" type="hidden" class="form-control" name="feeplace_id" value="{{ $feeplace->id }}"> 
...
<strong>{{ $errors->first('company_id') }}</strong>
 ...
 @endif
                  ...
                  <div class="form-group{{ $errors->has('date_start') ? ' has-error' : '' }}">
                      ...
                      <div class="col-md-6">
                          <input id="date_start" type="text" class="form-control" name="date_start" value="{{$feeplace->date_start}}">
                  ...
                  <div class="form-group{{ $errors->has('date_stop') ? ' has-error' : '' }}">
                      ...
                      <div class="col-md-6">
                          <input id="date_stop" type="text" class="form-control" name="date_stop" value="{{$feeplace->date_stop}}">
                  ...
                  <div class="form-group{{ $errors->has('period_begin_at') ? ' has-error' : '' }}">
                      ...
                      <div class="col-md-6">
                          <input id="period_begin_at" type="text" class="form-control" name="period_begin_at" value="{{$feeplace->period_begin_at}}">
                  ...
                  <div class="form-group{{ $errors->has('period_end_at') ? ' has-error' : '' }}">
                      ...
                      <div class="col-md-6">
                          <input id="period_end_at" type="text" class="form-control" name="period_end_at" value="{{$feeplace->period_end_at}}">
                      ...
                      <div class="col-md-6">
                          <select name="infant">
                              <option selected disabled>Выберите</option>
                               <option  value="{{ $fare_family->id }}" selected>
           ...
           <div class="form-group{{ $errors->has('type_flight') ? ' has-error' : '' }}">
                      ...
                      <div class="col-md-6">
                          <select name="type_flight">
                             ...
                             <option value="{{$feeplace->type_flight}}"selected>Любой</option>
  ...
  <div class="tab-pane fade" id="feesplace_order_data" role="tabpanel" aria-labelledby="feesplace_order_data-tab">
           ...
           <div class="form-group{{ $errors->has('type_fees_inscribed') ? ' has-error' : '' }}">
                      ...
                      <div class="col-md-6">
                          <select name="type_fees_inscribed">
                              <option selected disabled>Выберите тип</option>
                              <option value="{{$feeplace->country_id_departure}}" selected>{{$feeplace->country_id_departure}}</option>
           ...
           <div class="form-group{{ $errors->has('type_fees_charge') ? ' has-error' : '' }}">
                      <label for="type_fees_charge" class="col-md-4 control-label">Тип сбора за возврат</label>
                      <div class="col-md-6">
                          <select name="type_fees_charge">
                              <option selected disabled>Выберите тип</option>
                                <option value="{{$feeplace->type_fees_charge}}" selected>{{$feeplace->type_fees_charge}}</option>
                              <option value="1">FIX</option>
                              <option value="0">%</option>
                           
                          </select>
                          @if ($errors->has('type_fees_charge'))
                              <span class="help-block">
                <strong>{{ $errors->first('type_fees_charge') }}</strong>
                   </span>
                          @endif
                      </div>
                  </div>
                  ...
                  <div class="form-group{{ $errors->has('size_fees_inscribed') ? ' has-error' : '' }}">
                      ...
                      <div class="col-md-6">
                          <input id="size_fees_inscribed" type="text" class="form-control" name="size_fees_inscribed" value="{{$feeplace->size_fees_inscribed}}">
                  ...
                  <div class="form-group{{ $errors->has('size_fees_charge') ? ' has-error' : '' }}">
                      ...
                      <div class="col-md-6">
                          <input id="size_fees_charge" type="text" class="form-control" name="size_fees_charge" value="{{$feeplace->size_fees_charge}}">
                  ...
                  <div class="form-group{{ $errors->has('size_fees_exchange') ? ' has-error' : '' }}">
                      ...
                      <div class="col-md-6">
                          <input id="size_fees_exchange" type="text" class="form-control" name="size_fees_exchange" value="{{$feeplace->size_fees_exchange}}">
                  ...
                  <div class="form-group{{ $errors->has('max_fees_inscribed ') ? ' has-error' : '' }}">
                      ...
                      <div class="col-md-6">
                          <input id="max_fees_inscribed" type="text" class="form-control" name="max_fees_inscribed" value="{{$feeplace->size_fees_inscribed}}">
                  ...
                  <div class="form-group{{ $errors->has('max_fees_charge') ? ' has-error' : '' }}">
                      ...
                      <div class="col-md-6">
                          <input id="max_fees_charge" type="text" class="form-control" name="max_fees_charge"  value="{{$feeplace->size_fees_charge}}">
                  ...
                  <div class="form-group{{ $errors->has('max_fees_exchange') ? ' has-error' : '' }}">
                      ...
                      <div class="col-md-6">
                          <input id="max_fees_exchange" type="text" class="form-control" name="max_fees_exchange"  value="{{$feeplace->size_fees_exchange}}">
                  ...
                  <div class="form-group{{ $errors->has('min_fees_inscribed') ? ' has-error' : '' }}">
                      ...
                      <div class="col-md-6">
                          <input id="min_fees_inscribed" type="text" class="form-control" name="min_fees_inscribed" value="{{$feeplace->size_fees_inscribed}}">
                  ...
                  <div class="form-group{{ $errors->has('min_fees_charge') ? ' has-error' : '' }}">
                      ...
                      <div class="col-md-6">
                          <input id="min_fees_charge" type="text" class="form-control" name="min_fees_charge" value="{{$feeplace->size_fees_charge}}">
                  ...
                  <div class="form-group{{ $errors->has('min_fees_exchange') ? ' has-error' : '' }}">
                      ...
                      <div class="col-md-6">
                          <input id="min_fees_exchange" type="text" class="form-control" name="min_fees_exchange" value="{{$feeplace->size_fees_exchange}}">
          ...
          <div class="form-group{{ $errors->has('non_return') ? ' has-error' : '' }}">
                      ...
                      <div class="col-md-6">
                          <select name="non_return">
                              <option selected disabled>Выберите</option>
                               <option value="{{$feeplace->non_return}}" selected>{{$feeplace->non_return}}</option>
                              <option value="1" selected>Да</option>
                              <option value="0">Нет</option>
                          </select>
                 ...
                 <div class="form-group{{ $errors->has('type_deviation') ? ' has-error' : '' }}">
                      ...
                      <div class="col-md-6">
                          <select name="type_deviation">
                              <option selected disabled>Выберите тип</option>
                               <option value="{{$feeplace->type_deviation}}" selected>{{$feeplace->type_deviation}}</option>
                           <option value="1">FIX</option>
                              <option value="0">%</option>     
                          </select>
                ...
                <strong>{{ $errors->first('type_deviation') }}</strong>
                  ...
                  <div class="form-group{{ $errors->has('size_deviation') ? ' has-error' : '' }}">
                      ...
                      <div class="col-md-6">
                          <input id="size_deviation" type="text" class="form-control" name="size_deviation" value="{{$feeplace->size_deviation}}">
